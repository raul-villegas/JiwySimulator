...
/**
 * @brief Draws a square (not round) big pixel of given size and color. 
 * 
 * If the size is odd (recommended), the center of the square is at the given (x,y) position.
 * For color explanation, see the `setPixelColor` function.
 * 
 * @param img Image to put the square on
 * @param x Center of square 
 * @param y Center of square 
 * @param ch1_value Value for channel 1. Valid range: 0..255
 * @param ch2_value Value for channel 2. Valid range: 0..255
 * @param ch3_value Value for channel 3. Valid range: 0..255
 * @param size Size of the square. Recommended to make this odd.
 */
void DrawBigPixel(sensor_msgs::msg::Image::SharedPtr img, int x, int y, int ch1_value, int ch2_value, int ch3_value, int size);
